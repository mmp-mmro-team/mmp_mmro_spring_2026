...
| :---: | :---: | :---: | --- | --- | --- |
| 12 февраля  | 16:20 | Семинар 1 | Оптимизация: Проксимальный метод, ADMM |  | ¯\\\_(ツ)\_/¯  |
| 19 февраля | 10:30 | Семинар 2 | Оптимизация: ускорение, стохастика, редукция дисперсии, cvxopt, jax |  |  ¯\\\_(ツ)\_/¯ |
| 26 февраля | 10:30 | Семинар 3 |Оптимизация: Метод Ньютона. Квазиньютоновские методы |  | ¯\\\_(ツ)\_/¯  | 
| 5 марта | 8:45 | Семинар 4 | ЕМ-алгоритм: сходимость, скорость сходимости, связь с градиентным подъёмом | |  ¯\\\_(ツ)\_/¯ |
| 11 марта | 10:30 | Семинар 5 | <ul><li>ЕМ-алгоритм: решение задач (смеси распределений, GLAD)</li><li>ЕМ-алгоритм: пример решения super resolution</li></ul> |  | ¯\\\_(ツ)\_/¯ |
| 12 марта | 10:30 | Семинар 5.1 | <ul><li>ЕМ-алгоритм: решение задач (смеси распределений, GLAD)</li><li>ЕМ-алгоритм: пример решения super resolution</li></ul> |  | ¯\\\_(ツ)\_/¯ |
